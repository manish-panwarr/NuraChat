      ...
      ">
        ...
        <div style="padding: 30px 25px; text-align: center;">
          ...
          <p style="
            ...
            line-height: 1.6;
          ">
            <span style="font-size: 1.2rem; font-weight: 600; color: #0066ff;">
              Hello!
            </span>
            <br>
          ...
          <div style="margin-top: 30px;">
            <img
              src="https://imglink.io/i/6e97a703-94e2-4899-9677-ec6988615933.jpg"
              alt="ꍟ꒒ꀤꂦ Banner"
        ...
        ">
          ...
          <b>ꍟ꒒ꀤꂦ</b>. All rights reserved.
          <br>
          <span style="font-size: 11px;">
            A M_Creation Product
          </span>
        </div>
